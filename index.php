    ...
    <div class="container">
        ...
        <form action="status.php" method="POST">
            <div id="sid" class="form-group">
              ...
              <input type="text" name="stdid" id="stdid" class="form-control" placeholder="J17001" aria-describedby="helpId">
            </div>
            <div id="xm" class="form-group">
                <label for="name">姓名</label>
                <input type="text" name="name" id="name" class="form-control" onblur="isName(this.value)" placeholder="张三 " aria-describedby="helpId">
              </div>
